...
def encode_huffman_tree(root,encoding_table, current_code=""):
    ...
    encode_huffman_tree(root.right,encoding_table, current_code + "0")
...
text="this is an example for huffman_coding"
encoded_text, encoded_table=huffman_encode(text)
print("\Encoding table\n")
for k in sorted(encoded_table):
    print(k,":",encoded_table[k])
print()
print("Encoded text:", encoded_text)
decoded_text= huffman_decode(encoded_text, encoded_table)
